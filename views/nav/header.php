				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarCollapse">
						<ul class="navbar-nav me-auto mb-2 mb-md-0">
							<li class="nav-item">
								<a class="nav-link <?= $this->page == 'home'? 'active':'' ?>" aria-current="page" href="../page/home.php">Home</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $this->page == 'services'? 'active':'' ?>" href="../page/services.php">Services</a>
							</li>
							<li class="nav-item">
								<a class="nav-link <?= $this->page == 'contact'? 'active':'' ?>" href="../page/contact.php">Contact</a>
							</li>
						</ul>
